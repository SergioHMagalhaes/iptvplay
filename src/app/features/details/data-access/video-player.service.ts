...
export class VideoPlayerService {
  ...
  async play(mediaElement: HTMLVideoElement, src: string): Promise<void> {
    ...
    this.player = this.videojs(mediaElement, this.createOptions(src));
  ...
  private createOptions(src: string): VideoJsOptions {
    return {
      autoplay: true,
      controls: true,
      controlBar: {
